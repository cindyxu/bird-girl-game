...
public class CollideTrackerTest {

	[Test]
	public void ShiftWindowUp_nothingAbove_shouldStopAtMaxHeight()
	{
		List<Edge> edges = new List<Edge> ();
		ScanCollideTracker tracker = new ScanCollideTracker (edges, 1, 0, 1, 0);
	...
	public void GetSectionedLine_startingWithVerticalEdgeInBounds_shouldSplitOnEdge()
	{
		...
		List<ScanCollideTracker.Segment> segments = tracker.GetSectionedLine (0, 2, 0);
